        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div>
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-white mt-3 mb-6">
              4.5+ Years Driving Startups to Success
            </h2>
            <p className="text-gray-400 text-lg leading-relaxed mb-6">
              With extensive experience in startup funding and financial consulting, I specialize in transforming 
              ambitious ideas into funded realities. My approach combines deep industry knowledge with personalized 
              strategies tailored to each client's unique needs.
            </p>
            <p className="text-gray-400 leading-relaxed mb-8">
              I focus on strategic funding, financial structuring, and government-backed opportunities to help 
              startups not just survive, but thrive in competitive markets.
            </p>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-dark-800 border border-gray-700 rounded-2xl p-8 relative overflow-hidden">
              ...
              <div className="relative">
                <h3 className="text-2xl font-bold text-white mb-2">My Focus Areas</h3>
                ...
                <div className="space-y-4">
                  {['Startups', 'Funding', 'Compliance'].map((area, index) => (
                    <div key={index} className="flex items-center justify-between">
                      ...
                      <span className="text-primary font-semibold">{95 - index * 5}%</span>
                    </div>
                  ))}
                </div>
              </div>
